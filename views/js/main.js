...
function updatePositions() {
    ...
    for (var e = document.getElementsByClassName("mover"), a = 0; a < e.length; a++) {
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function () {
    var horizontalSpacing = window.innerWidth / 7,
        verticalSpacing = window.innerHeight / 4,
        pizzasPerRow = 8;
    for (var r = 0; 24 > r; r++) {
        var n = document.createElement("img");
        n.className = "mover", n.src = "images/pizza.png", n.style.height = "100px", n.style.width = "73.333px", n.basicLeft = r % pizzasPerRow * horizontalSpacing, n.style.top = Math.floor(r / pizzasPerRow) * verticalSpacing + verticalSpacing - 50 + "px", document.querySelector("#movingPizzas1").appendChild(n)
    }
    updatePositions()
});
